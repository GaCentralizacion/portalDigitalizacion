...
registrationModule.factory('facturaRepository', function($http) {
    return {
        ...
        //     return $http.get(facturaUrl + '7|' + folio + '|' + idUsuario); <--Se comento porque no obtenia los datos para la recepcion del material 
        ...
        getValidaSubeCompRecep: function(folio, idUsuario) {
            return $http({
                url: facturaApiUrl + 'ValidaSubeCompRecep/',
                method: "GET",
                params: {
                    folio: folio,
                    idUsuario: idUsuario
